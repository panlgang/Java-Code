...
public class QuickSort {
    ...
    private static int partition_1(int[] arr, int L, int R) {
        ...
        int i = L + 1;
        int j = L;
        //arr[L+1...j] < arr[L] , arr[j+1..i - 1] > arr[L](等于部分也在里面包括着)
    ...
    //双向调整,当数组大部分有序时会退化为O(N*N);等于的划分在前后两部分。
    ...
    //******************************************************************
//    public static int findKBigNumber(int[] arr,int k){
//        int L = 0;
//        int R = arr.length - 1;
//        int ret = findKBigNumber(arr,L,R,k);
//        return ret;
//    }
//    public static int findKBigNumber(int[] arr,int L,int R,int k){
//        while(L < R) {
//            int p = partition(arr, L, R);
//            if (p + 1 == k) {
//                return arr[p + 1];
//            } else if (p + 1 > k) {
//                return findKBigNumber(arr, L, p + 1, k);
//            } else {
//                return findKBigNumber(arr, p + 2, R, k - p - 1);
//            }
//        }
//        return 0;
//    }
//    public static int partition(int[] arr,int L,int R){
//        int v = L +(int) (Math.random() * (R - L + 1));
//        int left = 0;
//        int right = 0;
//        int less = L - 1;
//        while(L <= R){
